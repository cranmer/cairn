...
| Command | Purpose |
|---------|---------|
| `cairn mcp` | Run the MCP server over stdio (configured via `claude mcp add --scope user cairn -- cairn mcp`) |
